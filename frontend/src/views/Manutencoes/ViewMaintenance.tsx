      ...
      <div className="px-8 pb-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="flex flex-col">
              ...
              <InputText value={maintenance.machineName} readOnly className="w-full h-11 rounded-md border border-gray-300 shadow-sm focus:ring-2 focus:ring-[#0084FF33]" />
            </div>
            <div className="flex flex-col">
            ...
            <div className="flex flex-col">
              ...
              <Dropdown value={maintenance.status} options={statusOptions} optionLabel="label" optionValue="value" disabled className="w-full h-11 rounded-md border border-gray-300 shadow-sm" panelClassName="rounded-xl" />
            </div>
            <div className="flex flex-col">
