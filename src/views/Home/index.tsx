              ...
              <div className="bg-white rounded-[10px] p-6 flex-1 overflow-hidden flex flex-col">
                ...
                <div className="space-y-2 overflow-y-auto flex-1">
                  {[
                    ...
                    { status: 'Prevista', color: '#0084FFD4' },
                    { status: 'Pendente', color: '#F21515A8' }
                  ].map((item, index) => (
                    <div key={index} className="bg-[#D9D9D970] rounded-lg p-4 flex flex-col gap-1">
                      <div className="flex items-center justify-between">
                        ...
                        <span 
                          className="text-[#595454] text-[12px] px-2 py-[3px] rounded-[10px]" 
                          style={{ backgroundColor: item.color, fontFamily: 'Poppins, sans-serif', fontWeight: 500 }}
                        >
                          {item.status}
                        </span>
                      </div>
